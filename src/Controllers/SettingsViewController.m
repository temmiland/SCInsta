...
- (NSArray *)specifiers {
    if (!_specifiers) {        
        _specifiers = [NSMutableArray arrayWithArray:@[
            ...
            [self newSwitchCellWithTitle:@"Disable usage insights" detailTitle:@"Prevents skipping the usage blocking view." key:@"disable_usage_insights" defaultValue:false changeAction:nil],
